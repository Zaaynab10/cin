...
export function SuccessStep({ token, personalInfo, scheduleData, appointmentType, onNext }: SuccessStepProps) {
  ...
  return (
    <section className="apf-section">
      <div className="suc-card">
        ...
        {/* Title */}
        <h2 className="suc__title">Votre rendez-vous a bien été<br />enregistré</h2>
        ...
        <div className="suc__info-row">
          ...
          <p className="suc__info-text">
            ...
            <strong>{personalInfo?.email ?? "votre adresse"}</strong>.
            {" "}Si vous ne le recevez pas, pensez à vérifier votre dossier spam.
          </p>
        </div>
        ...
        <div className="suc__info-row">
          ...
          <p className="suc__info-text">
            <strong>Modification ou annulation</strong> possible jusqu&apos;à 48h avant via
            le lien sécurisé dans votre email. Passé ce délai, aucune modification ne sera
            possible.
          </p>
        </div>
