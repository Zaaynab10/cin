			...
			<section className="apt-hero" aria-labelledby="apt-hero-title">
				...
				<div className="apt-hero__content">
					...
					<p className="apt-hero__subtitle">
						Réservez votre créneau en ligne, sans création de compte. Un seul
						rendez-vous actif par numéro d'identification. Toute annulation doit
						être effectuée au moins 48h avant.
					</p>
				</div>
			</section>
			...
			>
				<div className="apt-zone__inner">
					...
					<p className="apt-zone__sub">
						Les créneaux disponibles vous seront proposés à l'étape suivante
						selon votre choix.
					</p>
				</div>
			</section>
