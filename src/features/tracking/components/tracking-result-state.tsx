      ...
      <div className="rs__body">
        <ul className="rs__info-list">
          <li className="rs__info-item">
            ...
            <div className="rs__info-body">
              <span className="rs__info-label">22 rue du Faubourg Saint-Honoré, 75008 Paris</span>
            </div>
          </li>
          <li className="rs__info-item">
        ...
        <div className="rs__notice rs__notice--orange">
          ...
          <p className="rs__notice-text">
            Réservé aux CIN de nouvelle génération. Les anciens formats ne sont pas acceptés.
          </p>
        </div>
        <div className="rs__actions">
          ...
          <Link className="rs__secondary" href="/">
            <IconRotateCcw className="rs__secondary-icon" />Nouvelle recherche
          </Link>
        </div>
      </div>
    </div>
      ...
      <div className="rs__body">
        <ul className="rs__info-list">
          <li className="rs__info-item">
            ...
            <div className="rs__info-body">
              <span className="rs__info-label">Notification par email et SMS</span>
              <span className="rs__info-text">Vous serez averti dès que votre CIN sera disponible.</span>
            </div>
          </li>
          <li className="rs__info-item">
            <IconClock className="rs__info-icon rs__info-icon--orange" />
            <div className="rs__info-body">
              <span className="rs__info-label">Délai habituel : 4 à 8 semaines</span>
              <span className="rs__info-text">À compter du dépôt du dossier.</span>
            </div>
          </li>
        </ul>
        <div className="rs__notice rs__notice--orange">
          <IconAlertTriangle className="rs__notice-icon rs__notice-icon--orange" />
          <p className="rs__notice-text">
            Si votre dossier date de plus de 3 mois sans notification, contactez le consulat.
          </p>
        </div>
        <div className="rs__actions">
      ...
      <div className="rs__body">
        <ul className="rs__info-list">
          <li className="rs__info-item">
            ...
            <div className="rs__info-body">
              <span className="rs__info-label">Numéro incorrect ou non enregistré</span>
              <span className="rs__info-text">Vérifiez le NIN saisi et qu'il s'agit d'une CIN nouvelle génération.</span>
            </div>
          </li>
          <li className="rs__info-item">
            <IconAlertTriangle className="rs__info-icon rs__info-icon--orange" />
            <div className="rs__info-body">
              <span className="rs__info-label">Seules les CIN de nouvelle génération</span>
              <span className="rs__info-text">sont suivies dans ce système.</span>
            </div>
          </li>
        </ul>
        ...
        <div className="rs__actions">
          ...
          <Link className="rs__secondary" href="/appointment">
            <IconArrowRight className="rs__secondary-icon" />Prendre un rendez-vous
          </Link>
        </div>
      </div>
    </div>
    ...
    <div className="rs-page rs-page--error" role="alert">
      ...
      <div className="rs__body">
        <ul className="rs__info-list">
          <li className="rs__info-item">
            ...
            <div className="rs__info-body">
              ...
              <span className="rs__info-text">Aucune action en ligne n'est possible.</span>
            </div>
          </li>
          <li className="rs__info-item">
            <IconAlertTriangle className="rs__info-icon rs__info-icon--orange" />
            <div className="rs__info-body">
              <span className="rs__info-label">Déplacement en personne requis</span>
              <span className="rs__info-text">Munissez-vous d'une pièce d'identité valide pour vous présenter au guichet.</span>
            </div>
          </li>
        </ul>
        <div className="rs__notice rs__notice--red">
        ...
        <div className="rs__actions">
          ...
          <Link className="rs__secondary" href="/">
            <IconSearch className="rs__secondary-icon" />Nouvelle recherche
          </Link>
        </div>
      </div>
    </div>
    ...
    <div className="rs-page rs-page--neutral" role="alert">
      ...
      <div className="rs__body">
        ...
        <div className="rs__notice rs__notice--grey">
          ...
          <p className="rs__notice-text">
            Cette mesure protège le service et garantit un accès équitable à tous les ressortissants.
          </p>
        </div>
        <div className="rs__actions">
          <Link className="rs__cta rs__cta--slate" href="/">
            <IconHome className="rs__cta-icon" />Retour à l'accueil
          </Link>
        </div>
      </div>
    </div>
