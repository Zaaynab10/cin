...
import { trackingResponseSchema, type TrackingResponse } from "../schemas/tracking.schema";

export async function fetchTrackingStatus(nin: string): Promise<TrackingResponse> {
